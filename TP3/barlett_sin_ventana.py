...
#   Ns = (2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096)    # Cantidad de muestras por realizacion
    Ns = np.array([1000], dtype=np.float)
    L = 10     # Cantidad de realizaciones
...
#%% 
    ...
    for N in Ns:
        ...
        noises = np.random.normal(mean, np.sqrt(variance), (int(N), L))
...
#    plt.grid()
    ...
    print("Varianza del bin promedio:c" + str(bin_var))
